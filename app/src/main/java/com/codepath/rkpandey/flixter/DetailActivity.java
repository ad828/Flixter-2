...
public class DetailActivity extends YouTubeBaseActivity {
    ...
    public static final String YOUTUBE_FINAL_API_KEY = "AIzaSyBUNVTfnPJHeN5EXDI9eYMWBnIG4LVafmY";
    ...
    private void initializeYoutube(final String youtubeKey) {
        youTubePlayerView.initialize(YOUTUBE_FINAL_API_KEY, new YouTubePlayer.OnInitializedListener() {
